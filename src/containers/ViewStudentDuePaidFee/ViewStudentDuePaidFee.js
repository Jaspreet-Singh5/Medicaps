...
class ViewStudentDuePaidFee extends Component {
...
export default connect(mapStateToProps, mapDispatchToProps)(withErrorHandler(withStyles(styles)(ViewStudentDuePaidFee), axios));