...
class ViewStudentFee extends Component {
      ...
      if (this.state.feesCollection.length == 0) {
        ...
        form = 
          ...
          <MaterialTable
                ...
                columns={[
                    { title: 'From', field: 'monthYear', type: 'date'
                    },
                    { title: 'Fee Structure', field: 'fees', type: 'string' }
                ]}
...
export default connect(mapStateToProps, mapDispatchToProps)(withErrorHandler(withStyles(styles)(ViewStudentFee), axios));