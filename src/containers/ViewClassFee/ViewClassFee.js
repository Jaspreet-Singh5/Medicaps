...
class ViewClassFee extends Component {
      ...
      if (this.state.feesCollection.length == 0) {
        ...
        form = 
          ...
          <MaterialTable
                ...
                title={'Attendance'}
                columns={[
                    { title: 'Section name', field: 'sectionName.name', text: 'string'
                    },
                    { title: 'All Fee', field: 'fees', type: 'string' },
...
const mapStateToProps = state => {
  return {
    ...
    loading: state.viewClassFees.loading,
    alert: state.viewClassFees.alert,
    error: state.viewClassFees.error
  };
};
...
export default connect(mapStateToProps, mapDispatchToProps)(withErrorHandler(withStyles(styles)(ViewClassFee), axios));